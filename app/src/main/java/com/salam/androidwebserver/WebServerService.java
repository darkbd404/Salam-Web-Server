...
public class WebServerService extends Service {
    ...
    private String adminHtml() {
        ...
        html.append(
                "<title>Salam Web Server Pro</title>"
        );
        ...
        html.append(
                "ADVANCED LAN SERVER CONTROL PANEL"
        );
        ...
        html.append(
                "<button class=\"green\" onclick=\"uploadFiles()\">UPLOAD FILES</button>"
        );
        ...
        html.append(
                "<small>"
                        +
                "Use comma-separated IPs or CIDR rules."
                        +
                "</small>"
        );
        ...
        html.append(
                ...
                "}"
                        +
                "const r=await fetch('/__api/upload',{"
                        +
                "method:'POST',"
                        +
                "body:data"
